...
SWalkback: '이거 고치던지 지우던지 해야돼!!!!
    ...
    SPEED 10
    MOVE G6A,100,  76, 145, 102, 100, 100 '원래는 102(4번째)
    MOVE G6D,100,  76, 145,  112, 100, 100 '원래 92
    MOVE G6B,100,  35,  80, 100, 100, 100
    MOVE G6C,100,  35,  80, 100, 120, 100
    WAIT

    MOVE G6A,100,  76, 145,  112, 100, 100
    ...
    MOVE G6D,100,  76, 145,  112, 100, 100
    MOVE G6B,100,  35,  80, 100, 100, 100
    MOVE G6C,100,  35,  80, 100, 120, 100
    WAIT
...
backstepleft: '뒷걸음질 원본
    ...
    MOVE G6C,110,  35,  80, 100, 120, 100
    WAIT
    '*************************************************
    GOSUB Leg_motor_mode2
    '오른발중심이동
